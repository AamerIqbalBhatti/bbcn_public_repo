...
Paper 3 v2 is the merged manuscript (Paper 3 with the Paper 4 additions). Like
...
## Build (self-contained; this is what Overleaf does)
    latexmk -pdf BBCN_paper3v2.tex          # or: bash build.sh   ->  BBCN_paper3v2.pdf
...
`paper3v2` is a **sibling** of `paper3`, not a copy of it: `assemble.sh` pulls the
...
## Overleaf
Sync the repo and set the main document to `paper3v2/BBCN_paper3v2.tex`. The .py
